    ...
    return (
        <div id="balance" className='ml-[23px] mt-[33px]'>
            ...
            <div className=' flex flex-row items-center mt-[4px]'>
                ...
                <div className='ml-[10px] py-[6px] px-[12px] border-[2px] border-[#8102FF] rounded-[10.7px]'>
            ...
            <span className='font-roboto ml-[26px] mt-[8px] text-[14px] text-[#6E6E6E] font-bold'>$5000 @TGE</span>
        </div>
    )
}
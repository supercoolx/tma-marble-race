            ...
            <div className="mt-[47px] divide-y-[1px]">
                <div className="py-[14px] flex items-center justify-between">
                    <div className="flex items-center gap-[11px]">
                        ...
                        <div className="flex flex-col items-start justify-between font-medium font-inter">
                            <div className="text-[8px] leading-[9.68px] text-[#757D7F] font-inter font-medium">1,000 Marbles</div>
                ...
                <div className="py-[14px] flex items-center justify-between">
                    <div className="flex items-center gap-[11px]">
                        ...
                        <div className="flex flex-col items-start justify-between font-medium font-inter">
                            <div className="text-[8px] leading-[9.68px] text-[#757D7F] font-inter font-medium">300 Marbles</div>
                ...
                {/* <div className="py-[14px] flex items-center justify-between">
                    <div className="flex items-center gap-[11px]">
                        ...
                        <div className="flex flex-col items-start justify-between font-medium font-inter">
                            <div className="text-[8px] leading-[9.68px] text-[#757D7F] font-inter font-medium">250 Marbles</div>
            ...
            <div className="mt-[23px] divide-y-[1px]">
                <div className="py-[14px] flex items-center justify-between">
                    <div className="flex items-center gap-[11px]">
                        ...
                        <div className="flex flex-col items-start justify-between font-medium font-inter">
                            <div className="text-[8px] leading-[9.68px] text-[#757D7F] font-inter font-medium">{`${dailyReward} Marbles`}</div>

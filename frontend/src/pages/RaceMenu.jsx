...
function RaceMenu () {
    ...
    const handleNavigate = (price) => (e) => {
        e.preventDefault()
        navigate('/pickColor',{state:{price}})
    }
    ...
    return(
        <div id="body_race_menu">
            ...
            <div className='mx-[12px] flex flex-col gap-4'>
                <div id="menu_race_1" onClick={handleNavigate(1)} className='flex flex-row gap-12 bg-[#1B1A21] rounded-[11px] px-4 py-[10px] cursor-pointer'>
                    ...
                    <div className='flex flex-col justify-center'>
                        ...
                        <div className='flex flex-row justify-center items-center mt-2'>
                            <img className='w-[13px] h-[13px]' src="/imgs/marble_ball.webp" alt=''/>
                            <span className='text-[15px] text-[#fff] ml-1 font-bold'>5</span>
                        </div>
                    </div>
                </div>

                <div id="menu_race_10" onClick={handleNavigate(10)} className='flex flex-row gap-12 bg-[#1B1A21] rounded-[11px] px-4 py-[10px] cursor-pointer'>
                    <div className='bg-black border-[#8102FF] border-[2px] rounded-[281px] w-[82px] h-[82px]'>
                    </div>
                    <div className='flex flex-col justify-center'>
                        <span className='text-[11.5px] text-[#6E6E6E]'>Price 1 Marble</span>
                    ...
                    <div className='flex flex-col justify-center'>
                        ...
                        <div className='flex flex-row justify-center items-center mt-2'>
                            <img className='w-[13px] h-[13px]' src="/imgs/marble_ball.webp" alt=''/>
                            <span className='text-[15px] text-[#fff] ml-1 font-bold'>50</span>
                        </div>
                    </div>
                </div>

                <div id="menu_race_100" onClick={handleNavigate(100)} className='flex flex-row gap-12 bg-[#1B1A21] rounded-[11px] px-4 py-[10px] cursor-pointer'>
                    <div className='bg-black border-[#8102FF] border-[2px] rounded-[281px] w-[82px] h-[82px]'>
                    </div>
                    <div className='flex flex-col justify-center'>
                        <span className='text-[11.5px] text-[#6E6E6E]'>Price 1 Marble</span>
                    ...
                    <div className='flex flex-col justify-center'>
                        ...
                        <div className='flex flex-row justify-center items-center mt-2'>
                            <img className='w-[13px] h-[13px]' src="/imgs/marble_ball.webp" alt=''/>
                            <span className='text-[15px] text-[#fff] ml-1 font-bold'>500</span>
                        </div>
                    </div>
                </div>
            </div>

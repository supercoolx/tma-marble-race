  ...
  return(
    <div id="body_game_mode">
      ...
      <div className='flex flex-col px-3 gap-3'>
        <div id="menu_rumble" onClick={() => navigate('/rumbleMenu')} className='flex flex-row items-center justify-between gap-3 bg-[#1B1A20] rounded-md p-3 cursor-pointer'>
        ...
        <div id="menu_race" onClick={() => navigate('/raceMenu')} className='flex flex-row items-center justify-between gap-3 bg-[#1B1A20] rounded-md p-3 cursor-pointer'>
          <div className='bg-black border-[#8102FF] border-[2px] rounded-[281px] p-6'>
          <svg

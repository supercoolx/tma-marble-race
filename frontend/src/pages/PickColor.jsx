            ...
            <div className='mx-[12px] flex flex-col gap-4'>
                <div className='flex flex-row gap-12 bg-[#1B1A21] rounded-[11px] px-4 py-[10px]'>
                    ...
                    <div className='flex flex-col justify-center'>
                        ...
                        <div className='flex flex-row items-center justify-center mt-2'>
                            <img className='w-[13px] h-[13px]' src="/imgs/marble_ball.webp" alt=''/>
                            <span className='text-[15px] text-[#fff] ml-1 font-bold'>{price*5}</span>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div className='bg-[#1B1A21] rounded-[11px] px-4 py-[16px] mt-2 text-center flex flex-col gap-3'>
                    ...
                    <div className='flex flex-row justify-around '>
                        <div className={`border-transparent border-[1px] p-1 rounded-full ${myColor == '#ffd700' && 'border-white'}`}>
                            <div onClick={handleClickColor('#ffd700')} className='w-[20px] h-[20px] bg-[#ffd700] rounded-full cursor-pointer'></div>
                        </div>
                        <div className={`border-transparent border-[1px] p-1 rounded-full ${myColor == '#e43292' && 'border-white'}`}>
                            <div onClick={handleClickColor('#e43292')} className='w-[20px] h-[20px] bg-[#e43292] rounded-full cursor-pointer'></div>
                        </div>
                        <div className={`border-transparent border-[1px] p-1 rounded-full ${myColor == '#ff6b00' && 'border-white'}`}>
                            <div onClick={handleClickColor('#ff6b00')} className='w-[20px] h-[20px] bg-[#ff6b00] rounded-full cursor-pointer'></div>
                        </div>
                            <div className={`border-transparent border-[1px] p-1 rounded-full ${myColor == '#2cca36' && 'border-white'}`}>
                        <div onClick={handleClickColor('#2cca36')} className='w-[20px] h-[20px] bg-[#2cca36] rounded-full cursor-pointer'></div>
                        </div>
                            <div className={`border-transparent border-[1px] p-1 rounded-full ${myColor == '#ff0219' && 'border-white'}`}>
                        <div onClick={handleClickColor('#ff0219')} className='w-[20px] h-[20px] bg-[#ff0219] rounded-full cursor-pointer'></div>
                        </div>
                    </div>
                </div>
            </div>
